...
const InvitationForm = ({ title, receiverName, className }) => {
  ...
  return (
    <div className="">
      ...
      >
        ...
        <h1 className="align-middle font-semibold">{title}</h1>
      </div>

      <div className={` mx-auto p-6 bg-white md:mt-9 ${className}`}>
        <div className="space-y-6">
          ...
          <div className="flex justify-center items-center h-full">
            <button
              ...
              className="w-1/2 bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200 text-lg"
            >
              Invite
            </button>
          </div>
