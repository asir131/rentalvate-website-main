...
const ManagerRegistrationForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Basic validation
    const requiredFields = ['fullName', 'email', 'propertyName', 'streetAddress','city', 'zipCode','state'];
  ...
  return (
    <div className="flex   flex-col mx-1 md:mx-80 ">
      ...
      <form onSubmit={handleSubmit} className="w-full">
        <div className="mt-5 md:mt-10 md:flex gap-8 md:gap-20 md:mx-20 flex-col md:flex-row">
          ...
          <div className="md:w-2/4 w-full mx-auto p-6 bg-white rounded-lg">
            ...
            <div className="mb-4">
             ...
             <div className="mb-4 flex gap-2 justify-between w-full">
        ...
        {
            formData.email && (
                <ManagerSuccessModal isOpen={isOpen} close={closeModal} />
            )
        }
