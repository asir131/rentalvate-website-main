...
const CreateBidPostForm = () => {
  ...
  const [budgetType, setBudgetType] = useState("fixed"); // 'fixed' or 'negotiable'
  const [estimatedCost, setEstimatedCost] = useState("");

  console.log("Budget Type and estimated cost", budgetType, estimatedCost);
    ...
    <div className="max-w-5xl mx-auto my-8">
      <div className="w-full max-w-2xl mx-auto my-4 px-2 lg:px-0">
        <form onSubmit={submissionHandler}>
          ...
          {/* Estimated cost or input budget($)*/}
          <div>
            <Label
            ...
            <div className="relative mt-1">
              <Input
                ...
                className={`pr-24 placeholder:text-gray-400 w-1/2${
                  budgetType === "negotiable" ? "bg-gray-50" : ""
                }`}
              />

              {/* Negotiable Dropdown */}
              <Select value={budgetType} onValueChange={setBudgetType}>
                <SelectTrigger className="absolute right-1 top-1/2 -translate-y-1/2 w-auto h-8 border-0 bg-orange-500 hover:bg-orange-600 text-white px-3 focus:ring-0 focus:ring-offset-0">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            {budgetType === "negotiable" && (
              <p className="text-xs text-orange-500 mt-1">
                Price will be negotiable with contractors
              </p>
            )}
          </div>
...
export default CreateBidPostForm;
